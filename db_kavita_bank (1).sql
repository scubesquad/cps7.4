...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 04, 2024 at 08:30 AM
...
(0001, 'KAVITA URBAN CO-OPERATIVE BANK LTD, SOLAPUR ', 813, 'SHUKRAWAR PETH,GANGANHALI MARKET   ', 'MANIK CHOWK', '', 1, 2, 1, 1, '413002', '', '', '', '', 0, 0, '', '', '', 'a:1:{i:0;a:3:{i:0;s:36:\"HP6B4A7C (HP LaserJet Pro M404-M405)\";i:1;s:6:\"tray 1\";i:2;s:5:\"tray2\";}}');
...
(1, '002', 'BRANCH', '', '', '202, SHUKRAWAR PETH, GANGANHALI MARKET, MANIK CHOWK', '', '', 1, 2, 1, 1, 413002, '', '', '', '', '7896541257', '', '', '', NULL, 'HDFC0CKUCBS', NULL, NULL, 0, 0, '', 0, 413, '', '', '', '', '', '002');
...
(2, 11, 1, 2, 000001, 999999, 000001, 1, NULL);
...
DROP TABLE IF EXISTS `tb_cps_payorder`;
...
(1, 1, 000025, 000027, 01, 003, '2023-11-21', 1),
(2, 1, 000028, 000030, 01, 003, '2023-11-22', 1),
(3, 1, 000001, 000003, 01, 003, '2023-11-22', 1),
(4, 1, 000004, 000006, 01, 003, '2023-11-22', 1),
(5, 1, 000007, 000008, 01, 002, '2024-02-05', 1),
(6, 1, 000009, 000010, 01, 002, '2024-02-05', 1),
(7, 1, 000239, 000240, 01, 002, '2024-02-07', 1),
(8, 1, 000241, 000242, 01, 002, '2024-02-07', 1);
...
DROP TABLE IF EXISTS `tb_cps_payorderseries`;
...
(1, 001, 1, 002, 000001, 100000, 000287);
...
DROP TABLE IF EXISTS `tb_cps_payorder_reprintque`;
...
INSERT INTO `tb_cps_payorder_reprintque` (`id`, `pay_branch_id`, `cps_chq_no_from`, `cps_chq_no_to`, `cps_no_of_books`, `cps_book_size`, `cps_date`, `cps_process_user_id`, `cps_reprint_approved`) VALUES
(4, 1, 000028, 000030, 01, 003, '2023-11-22', 1, 0),
(5, 1, 000001, 000003, 01, 003, '2023-11-22', 1, 0),
(6, 1, 000004, 000006, 01, 003, '2023-11-22', 1, 0);
...
('', 'uploads/', 'Excel', '', '', 'Excel', '', '', 0, 1, 000000, 000000, 9, 365, 'KAVITA URBAN CO-OPERATIVE BANK LTD, SOLAPUR ', 'DevHarsh Infotech Pvt Ltd', 'thane logo.jpg', 'Penguins.jpg', '', '', '', '', '', 360, '', '', '', '0000-00-00', 0, '0000-00-00', 0, 0, 0, 0);
...
--
-- Table structure for table `tb_payorder`
--

DROP TABLE IF EXISTS `tb_payorder`;
CREATE TABLE IF NOT EXISTS `tb_payorder` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `branch_name` varchar(50) NOT NULL,
  `pay` varchar(200) NOT NULL,
  `amount` varchar(50) NOT NULL,
  `date` date NOT NULL,
  `amount_in_word` varchar(100) NOT NULL,
  `issuing_branch` varchar(50) NOT NULL,
  `payble_at` varchar(100) NOT NULL,
  `status` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tb_payorder`
--

INSERT INTO `tb_payorder` (`id`, `branch_name`, `pay`, `amount`, `date`, `amount_in_word`, `issuing_branch`, `payble_at`, `status`) VALUES
(11, '1', 'uh', '45', '2024-02-04', 'Forty five thousand four hundred fourty four', 'dd', 'sss', 'print'),
(10, '1', 'uh', '45444', '2024-02-05', 'Forty five thousand four hundred fourty four', 'dd', 'sss', 'print'),
(12, '1', 'uhqqq', '45444', '2024-02-06', 'Forty five thousand four hundred fourty four', 'ddw', 'qqq', 'print'),
(13, '1', 'uhqq', '45', '2024-02-04', 'Forty five thousand four hundred fourty four', 'dd', 'sss', 'print'),
(14, '1', 'uhqq', '250000', '2024-02-05', 'Forty five thousand four hundred fourty four', 'ddw', 'qqq', 'print'),
(15, '1', 'Vaidhyanath bank', '45444', '2024-02-05', 'Forty five thousand four hundred fourty four', 'ddw', 'qqq', 'print'),
(16, '1', 'uh', '45', '2024-02-05', 'Forty five thousand four hundred fourty four', 'dd', 'sss', 'print'),
(17, '1', 'Vaidhyanath bank pvt', '45444', '2024-02-04', 'Forty five thousand four hundred fourty four', 'dd', '22sss', 'print'),
(18, '1', 'uh', '45', '2024-02-04', 'Forty five thousand four hundred fourty four', 'dd', 'sss', 'print'),
(19, '1', 'uh', '45', '2024-02-04', 'Forty five thousand four hundred fourty four', 'dd', 'sss', 'print'),
(20, '1', 'uh', '45444', '2024-02-05', 'Forty five thousand four hundred fourty four', 'dd', 'sss', 'print'),
(21, '1', 'qqq', '45444', '2024-02-05', 'Forty five thousand four hundred fourty four', 'dd', 'sss', 'print'),
(22, '1', 'uh', '45444', '2024-02-04', 'Forty five thousand four hundred fourty four', 'dd', '22sss', 'print'),
(23, '1', 'qqq', '45444', '2024-02-04', 'Forty five thousand four hundred fourty four', 'ddw', 'sss', 'print'),
(24, '1', 'kavita bank', '45444', '2024-02-04', 'Forty five thousand four hundred fourty four', 'ddw', 'sss', 'print'),
(25, '1', 'kavita bank', '45444', '2024-02-05', 'Forty five thousand four hundred fourty four', 'dd', 'sss', 'print'),
(26, '1', 'kavita bank', '45444', '2024-02-05', 'Forty five thousand four hundred fourty four', 'dd', '22sss', 'print'),
(27, '1', 'kavita bank', '45444', '2024-02-04', 'Forty five thousand four hundred fourty four', 'ddw', '22sss', 'print'),
(36, '1', 'uhqq', '45444', '2024-02-12', 'forty-five thousand four hundred and forty-four Only', 'dd', '22sss', 'print'),
(29, '1', 'kavita bank', '45444', '2024-02-05', 'forty-five thousand four hundred and forty-four rupees', 'dd', 'sss', 'print'),
(30, '1', 'kavita bank', '250000', '2024-02-05', 'two lakh fifty thousand rupees', 'dd', 'sss', 'print'),
(31, '1', 'kavita bank', '250000', '2024-02-05', 'two lakh fifty thousand', 'ddw', 'sss', 'print'),
(32, '1', 'kavita bank', '250000', '2024-02-05', 'two lakh fifty thousand', 'ddw', 'sss', 'print'),
(33, '1', 'kavita bank', '45444', '2024-02-05', 'forty-five thousand four hundred and forty-four Only', 'dd', '22sss', 'print'),
(34, '1', 'kavita bank', '250000', '2024-02-04', 'two lakh fifty thousand Only', 'dd', '22sss', 'print'),
(35, '1', 'kavita bank', '250000', '2024-02-04', 'two lakh fifty thousand Only', 'ddw', '22sss', 'print'),
(37, '1', 'kavita bank', '45444', '2024-02-12', 'forty-five thousand four hundred and forty-four Only', 'dd', '22sss', 'print'),
(38, '1', 'uh', '45444', '2024-02-11', 'forty-five thousand four hundred and forty-four Only', 'dd', 'qqq', 'print'),
(39, '1', 'kavita bank', '45444', '2024-02-05', 'forty-five thousand four hundred and forty-four Only', 'dd', '22sss', 'print'),
(40, '1', 'kavita bank', '45444', '2024-02-13', 'forty-five thousand four hundred and forty-four Only', 'branch', 'branch', 'print'),
(41, '1', 'kavita bank', '45444', '2024-02-13', 'forty-five thousand four hundred and forty-four Only', 'branch', 'branch', NULL),
(42, '1', 'kavita bank', '250000', '2024-02-12', 'two lakh fifty thousand Only', 'branch', 'branch', 'print'),
(43, '1', 'kavita bank', '45444', '2024-02-11', 'forty-five thousand four hundred and forty-four Only', 'branch', 'branch', 'print'),
(44, '1', 'kavita bank', '250000', '2024-02-12', 'two lakh fifty thousand Only', 'ddw', 'branch', NULL),
(45, '1', 'kavita bank', '45444', '2024-02-12', 'forty-five thousand four hundred and forty-four Only', 'dd', '22sss', 'print');
...
INSERT INTO `tb_payorder_reprint_req_collection` (`id`, `pay_branch_id`, `cps_chq_no_from`, `cps_chq_no_to`, `cps_no_of_books`, `cps_book_size`, `cps_date`, `cps_process_user_id`) VALUES
(1, 1, 000025, 000027, 01, 003, '2023-11-21', 16);
...
CREATE TABLE IF NOT EXISTS `tb_pending_print_req` (
  ...
  `cps_chq_no_from` varchar(100) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
  `cps_chq_no_to` bigint(6) UNSIGNED ZEROFILL NOT NULL,
  `cps_micr_account_no` int(6) UNSIGNED ZEROFILL NOT NULL,
  `cps_date` date NOT NULL,
  `cps_process_user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_printque` (
  ...
  `cps_act_mobile` varchar(15) NOT NULL,
  `cps_ifsc_code` varchar(12) DEFAULT NULL,
  `cps_chq_no_from` varchar(10) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
  `cps_chq_no_to` bigint(6) UNSIGNED ZEROFILL NOT NULL,
  `cps_micr_account_no` int(6) UNSIGNED ZEROFILL NOT NULL,
  `cps_date` date NOT NULL,
  `cps_process_user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_print_req_collection` (
  ...
  `cps_act_mobile` varchar(15) NOT NULL,
  `cps_ifsc_code` varchar(12) DEFAULT NULL,
  `cps_chq_no_from` varchar(6) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
  `cps_chq_no_to` bigint(6) UNSIGNED ZEROFILL NOT NULL,
  `cps_micr_account_no` int(6) UNSIGNED ZEROFILL NOT NULL,
  `cps_date` date NOT NULL,
  `cps_process_user_id` int(11) NOT NULL,
...
(1, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(2, 00000000, 413813002, 002, '354600000026', 'TEST', 01, '0', 004, 10, '', '', '', '', '', '', 'KALYAN', '', '', '', '', 'mumbai', '', '', '', 400708, '', '', '', '', '000001', 000004, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(3, 00000000, 413813002, 002, '2388788557', 'ABCEDER', 04, '0', 003, 10, '', '', '', '', '', '', 'FDGFDG', '', '', '', '', 'than', '', '', '', 454645, '', '', '', 'DMKJ0000019', '', 000011, 000133, '2024-02-13', 1, 0, '', '', NULL, NULL, NULL, NULL),
(4, 00000000, 413813002, 002, '2388788557', 'ABCEDER', 04, '0', 003, 10, '', '', '', '', '', '', 'FDGFDG', '', '', '', '', 'than', '', '', '', 454645, '', '', '', 'DMKJ0000019', '', 000011, 000133, '2024-02-13', 1, 0, '', '', NULL, NULL, NULL, NULL);
...
(2, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-22', 1, 0, '', '', NULL, NULL, NULL, NULL),
(3, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(4, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(5, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(6, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(7, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(8, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(9, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(10, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(11, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(12, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(13, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(14, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(15, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(16, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL),
(17, 00000000, 413813002, 002, '1234567890', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST1', '', '', '', '', 'test', '', '', '', 400708, '', '', '', '', '000001', 000003, 006780, '2023-11-23', 1, 0, '', '', NULL, NULL, NULL, NULL);
...
(1, 'SOLAPUR', '413002', 'SOL001', 'SOL', 1, 2, 1, 0);
