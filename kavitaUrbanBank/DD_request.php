	...
	$( "#dialog-confirm" ).dialog({
            ...
            buttons: {
                ...
                Ok: function() {  
						...
						$.ajax({type: "POST", url: "post_DD_request.php", dataType: 'json', data: "do=reprint&ids="+selected_ids_array,
...
<div id="formdiv">
	<div id="formheading">DD Reprint Cheques</div>
	<div id="formfields">
		<form id="frmreprint" name="frmreprint" enctype="multipart/form-data" action="post_DD_request.php" method="POST">
