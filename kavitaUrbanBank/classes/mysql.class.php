<?php
	...
	class db {
		...
		// function to insert log data
		function insertLog($table, $name, $recordId, $userId, $actionPerformed, $details, $message=""){
			$date = date('Y-m-d H:i:s');
			$json = json_encode($details);

			// return $prevJson;
			$query = "INSERT INTO log_table(`table_name`, `name`, `record_id`, `user_id`, `action_performed`, `previous_details`, `details`, `created`, `message`) VALUES('$table', '$name', '$recordId', '$userId', '$actionPerformed', '{}', '$json', '$date', '$message')";
