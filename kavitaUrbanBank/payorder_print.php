...
function printCheques($type,$firstchequedata,$secondchequedata,$thirdchequedata,$noofCheque,$printersinfo)
{
	...
	// Positions
	$arrPos    = array(); 
	$arrPos[0] = array("BankAddrY" => 10, "ifscY" => 14, "PayOrderY" => 28, "VUniqReq" => 76, "MICRY" => 82.8);
	$arrPos[1] = array("BankAddrY" => 102.5, "ifscY" => 106.5, "PayOrderY" => 120.4, "VUniqReq" => 169, "MICRY" => 176.2);
	$arrPos[2] = array("BankAddrY" => 196.5, "ifscY" => 205.5, "PayOrderY" => 213.8, "VUniqReq" => 262, "MICRY" => 267);
	...
	{ 
		...
		$pdf->Text($ifscX, $arrPos[$i]["ifscY"],'IFSC : HDFC0CKUCBS / YESB00KUCB1');
