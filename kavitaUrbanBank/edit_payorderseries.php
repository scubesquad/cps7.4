...
<?php require_once('header.php');?>
                <div id="formdiv">
                    ...
                    <div id="formfields">
                   <form id="frmchequeseries" name="frmchequeseries" enctype="multipart/form-data" action="post_payorderseries.php?todo=edit&id=<?php echo @$_REQUEST['id'];?>" method="POST" autocomplete="off">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
						  ...
						  <tr>
							...
							$sqlseries = "SELECT * FROM tb_cps_payorderseries WHERE series_id = ".GetSQLValueString($_REQUEST['id'],'int')."";
						    ...
						    <div id="formfields">                    				    	
								...
								<div id="formfields">
                    				<table width="600px" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="height: 35px; text-align: left">
												<label>Error in request please <a href="manage_payorderseries.php">click here</a> to go back to cheque series.</label>
											</td>
										</tr>
									</table>
					    		</div>
