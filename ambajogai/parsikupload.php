						  ...
						  <tr>
							...
							<div style="float:left">&nbsp;&nbsp;<label>Transaction Type </label>
								<select name="ddlTranType" id="ddlTranType" style="width:198px; height:26px;">
									...
									<?php
										$rowgetbranch =  $db->get_results("SELECT distinct(transactioncode),b.transactioncode, b.transactioncodedescription FROM tb_cps_transactioncodes b INNER JOIN  tb_uploadingdata prc ON b.transactioncode = prc.cps_tr_code WHERE 1=1 ".$branch_search);
										if($rowgetbranch){
										foreach($rowgetbranch as $eachbranch){
