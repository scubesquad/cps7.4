...
function validation()
{
	if (document.getElementById("cust").value == "") {
        document.getElementById("divmsg").innerHTML = "&nbsp;Please Enter Customer Name.";
        return false;
    }
	else{
			...
			style="border: 1px solid; border-color: #cccccc;"><table width="969" border="0" cellspacing="0" cellpadding="0">
				...
				?>
					...
					?>
						  ...
						  <a href="<?php echo $urlexcel; ?>" target="_blank"><input type="button" id="button" value="Export to Excel" class="ui-button ui-widget ui-state-default ui-corner-all" role="button" aria-disabled="false" /></a>
						  </td>
                          </tr>
                        </div>
                        <?php
