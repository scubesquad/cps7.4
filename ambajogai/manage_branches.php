													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0" id="categorytable">
														<thead>
															<tr class="formtitlehead" style="background-color:#E6E6E6">
																...
																<th width="16%" align="left">Branch Name</th>
																<th width="6%" align="left">Branch Code</th> 
																<th width="10%" align="left">Branch Sub Code</th> 
														...
														<tbody>
															  ...
															  ?>
																<tr class="alternate" id="row_<?php echo $row->branch_id; ?>" style="border-bottom:1px solid #ccc">
																    ...
																    <td style="border-bottom:1px solid #ccc" align="left" valign="middle" class="formtitle"><?php echo stripslashes($row->branch_code); ?></td>																    							<td style="border-bottom:1px solid #ccc" align="left" valign="middle" class="formtitle"><?php echo stripslashes($row->branch_sub_code); ?></td>									
