...
class PrintService
{
	    ...
	    if ($this->printQueryService->checkPrintqueEmptyOrNot()) 
	    {
	        ...
	        if (count($result) > 0) {
	            ...
	            for ($j = 0; $j < count($firstrequestsliprow); $j++) {
	                ...
	                $html .= $this->printSlipService->printRequestSlip($pdf, 2, $firstrequestslipdata, $secondrequestslipdata, $thirdrequestslipdata, 3, $noofbooks, $printersinfo, $transactionKey, $bank);
	                $noofbooks++;
	            }
	            $html .= "<br>";
	            ...
	            for ($j = 0; $j < count($firstchequerow); $j++) {
	                ...
	                $html .= $this->printChequeService->printCheques($pdf, 3, $firstchequedata, $secondchequedata, $thirdchequedata, 3, $printersinfo, $bank);
	            }
	            ...
	            return [
	            	'status' => 203,
	            	'message' => "The cheques were printed successfully."
	            ];
	        }
	...
	public function insertIntoPrintCollection($result){
		...
		if($results) 
        {
            ...
            $printReqCollection->cps_process_user_id = $results->cps_process_user_id;
