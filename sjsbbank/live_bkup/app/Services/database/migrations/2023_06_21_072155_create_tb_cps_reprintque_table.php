...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tb_cps_reprintque', function (Blueprint $table) {
            ...
            $table->integer('cps_no_of_books')->nullable();
            $table->string('cps_dly_bearer_order', 1)->nullable();
            $table->integer('cps_book_size')->nullable();
            $table->unsignedInteger('cps_tr_code')->nullable();
            $table->string('cps_atpar', 10)->nullable();
            ...
            $table->integer('cps_reprint_approved')->default(0);
    ...
    {
        Schema::dropIfExists('tb_cps_reprintque');
    }
};
