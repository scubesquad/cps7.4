                                    ...
                                    <form class="" method="POST" action="{{ route('manualStore') }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="{{old('customer_ac_no') ? old('customer_ac_no') : ''}}" name="customer_ac_no" placeholder="Customer A/C No" id="" />
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="{{old('micr_ac_no') ? old('micr_ac_no') : ''}}" name="micr_ac_no" placeholder="MIRC A/C No" id="" />
