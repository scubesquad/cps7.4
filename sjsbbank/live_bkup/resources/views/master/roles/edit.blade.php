                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <div class="row">
                                                            ...
                                                            <?php $role = ['role.view', 'role.edit', 'role.add']; ?>
                                                            @php $i=1; @endphp
                                                            @foreach($permissions as $perm)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <div class="row">
                                                            ...
                                                            <?php $upload = ['transaction.view', 'transaction.upload', 'transaction.filter', 'transaction.delete', 'transaction.print', 'transaction.manual','transaction.list']; ?>
                                                            @php $i=1; @endphp
                                                            @foreach($permissions as $perm)
