	...
	public function update($req){
		...
		if($req->banklogo != "")
		{
			if($req->hasFile('banklogo')){
                ...
                $req->file('banklogo')->storeAs('setting/', $fileName, 'public');

                $banklogo = 'setting/'.$fileName;
			}
		}
		...
		if($req->desktop_image != "")
		{
			if($req->hasFile('desktop_image')){
                ...
                $req->file('desktop_image')->storeAs('setting/', $fileName, 'public');

                $desktopImage = 'setting/'.$fileName;
			}
		}
