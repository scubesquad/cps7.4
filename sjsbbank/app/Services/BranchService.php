...
class BranchService{
	...
	public function list(){
		return Branch::select('branch_id', 'branch_name', 'branch_short_name' , 'branch_code', 'branch_sub_code')->orderBy('branch_id', 'desc');
	}
	...
	public function store($req=null){
		...
		$branch->branch_short_name = $req->branch_short_name;
