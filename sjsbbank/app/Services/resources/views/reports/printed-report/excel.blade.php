...
<head>
	...
	<title>Printed Reports Excel</title>
</head>
<body>
	...
	<table>
		<thead>
			<tr>
				<th colspan="11" align="center"><b>Printed Reports for period : {{ date('d-m-Y', strtotime(Request()->start_date)) }} to {{ date('d-m-Y', strtotime(Request()->end_date)) }}</b></th>
			</tr>
			<tr>
				<th><b>SR. NO.</b></th>
				<th><b>OPERATOR</b></th>
