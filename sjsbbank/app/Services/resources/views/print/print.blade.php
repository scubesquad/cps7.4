                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Print Cheques</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-muted">
                                        <a href="javascript::void(0)" class="text-muted text-hover-primary">Print Cheques</a>
                                    </li>
                                    <!--end::Item-->
                                    <!--begin::Item-->
...
@push('scripts')
	<script>
        ...
        function callPrinterIssueFunction(id, message){
            $.ajax({  
                url: '/prints/removePrintCollection',  
                type: 'post',
                data: {id:id},
            ...
            $.ajax({  
                ...
                success: function(data) {
                    if(data.status == 200)
                    {
                        ...
                        console.log('Tray name is '+data.message.chequetray)
