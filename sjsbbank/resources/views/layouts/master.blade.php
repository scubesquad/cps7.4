							...
							<div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
								...
								<div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
									...
									@if($subdomain[0] != "cpsmaster")
										...
										@if(Auth::user()->can('country.view') || Auth::user()->can('state.view') || Auth::user()->can('branch.view') || Auth::user()->can('transaction-code.view') || Auth::user()->can('cheque-series.view') || Auth::user()->can('bank.view') || Auth::user()->can('account-charges.view'))
											<!--begin:Menu item-->
											<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 @if(Request::is('master/*'))here show @endif">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
													...
													@can('account-charges.view')
													<!--begin:Menu item-->
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="{{url('master/account-charges/list')}}">
															
															<span class="menu-title">Account Charges Master</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
										...
										@if(Auth::user()->can('transaction.view') || Auth::user()->can('pending-print-req.view') || Auth::user()->can('reprint-request.view'))
											...
											<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 @if(Request::is('transaction/*') || Request::is('reprint') || Request::is('pending-print-req/list'))here show @endif">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
													...
													@can('transaction.manual')
													<!--begin:Menu item-->
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="{{url('transaction/manual')}}">
															
															<span class="menu-title">Cheque Request Form</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													<div class="menu-item">
														...
														<a class="menu-link" href="{{url('transaction/upload')}}">
															...
															<span class="menu-title">Cheque Requests</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													<div class="menu-item">
														...
														<a class="menu-link" href="{{url('transaction/list')}}">
															...
															<span class="menu-title">Printed Cheque List</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
										...
										@if(Auth::user()->can('report.printed-report-day-wise') || Auth::user()->can('report.printed-report-selected-period') || Auth::user()->can('report.consolidate-report-daily') || Auth::user()->can('report.consolidate-report-monthly') || Auth::user()->can('report.reprint') || Auth::user()->can('report.customer') || Auth::user()->can('report.outputfile') || Auth::user()->can('report.outputfile-via-text') || Auth::user()->can('report.printed-detail-report') )
											<!--begin:Menu item-->
											<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 @if(Request::is('reports/*'))here show @endif">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
													...
													@can('report.printed-detail-report')
													<!--begin:Menu item-->
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="{{ url('report/printed-detail-report') }}">
															<span class="menu-title">Printed Cheque Detailed Report</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													@can('report.reject-request-report')
													<!--begin:Menu item-->
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="{{ url('report/reject-request-report') }}">
															<span class="menu-title">Rejected Requests Report</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													<div class="menu-item">
														...
														<a class="menu-link" href="{{ url('report/outputfile') }}">
															<span class="menu-title">Output File Excel</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													<div class="menu-item">
														...
														<a class="menu-link" href="{{ url('report/outputfile-via-text') }}">
															<span class="menu-title">Output File Text</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
									...
									@if(Auth::user()->can('role.view') || Auth::user()->can('manage-user.view') || Auth::user()->can('backup') || Auth::user()->can('setting') || Auth::user()->can('positional-setting.view'))
									<!--begin:Menu item-->
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 @if(Request::is('master/role/*') || Request::is('user/*') || Request::is('app/backup') || Request::is('setting'))here show @endif">
										...
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
											...
											@can('positional-setting.view')
											<!--begin:Menu item-->
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="{{ url('positional/setting') }}">
													<span class="menu-title">Cheque/Slip Positional Setting</span>
												</a>
												<!--end:Menu link-->
											</div>
											<!--end:Menu item-->
											...
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="d-flex flex-column">
													...
													@if($subdomain[0] != "cpsmaster")
														...
														<p class="fw-semibold text-muted fs-7">{{Auth::user()->getRoleNames()->first()}}</p>
													@endif
