                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <input type="hidden" class="form-control" name="branch_sub_code" id="branch_sub_code" maxlength="5" readonly />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
                ...
                if(val.length > 0)
                {
                    swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            //console.log(val)
                            $.ajax({
                                url: "{{ url('/transaction/upload/delete') }}",
                                type: "post",
                                data: {id:val},
                                success: function( response ) {
                                    getFilterDetails()
                    ...
                    if(isCheck == "complete"){
                        swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ url('/transaction/upload/reject-print-request') }}",
                                    type: "post",
                                    data: {id:val},
                                    success: function( response ) {
                                        swal.fire({
            ...
            function getFilterDetails(){
                $.ajax({
                    url: "{{ url('/transaction/get-filter-details') }}",
                    type: "get",
                    success: function( response ) {
                        //console.log(response)
                        if(response.status == 200){
            ...
            if (branch_id) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#branch_sub_code').val(response.data.branch_sub_code);
