            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="add_user_modal_form" class="form" action="#">
                    ...
                    <div class="row g-9 mb-8">
                        <!--begin::Col-->
                        <div class="col-md-12 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Select Branch</label>
                            <select class="form-select form-select-solid" name="branch_name">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="Enter phone number" name="phone_number" />
                    ...
                    <div class="row g-9 mb-8">
                        <!--begin::Col-->
                        <div class="col-md-12 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">OTP Verification</label>
                            <select class="form-select form-select-solid" name="otp_verification">
                                <option value="1">Active</option>
                                <option value="0">Inactive</option>
                            </select>
                        </div>
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="edit_user_modal_form" class="form" action="#">
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Select Branch</label>
                            <select class="form-select form-select-solid" id="editBranchName" name="branch_name">
                                <!-- <option value="">Select Branch</option>
                                @foreach($branches as $branch)
                                <option value="{{ $branch->branch_id }}">{{ $branch->branch_name }}</option>
                                @endforeach -->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="Enter phone number" name="phone_number" id="editPhoneNumber" />
                        <label for="phone_number" class="error"></label>
                    </div>
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">OTP Verification</label>
                            <select class="form-select form-select-solid" id="editOtpVerification" name="otp_verification">
                                <option value="1">Active</option>
                                <option value="0">Inactive</option>
                            </select>
                        </div>
            ...
            $('body').on('click', '.btn-active-light-primary', function(){
                ...
                $.ajax({
                    ...
                    success: function( response ) {
                        ...
                        $('#editOtpVerification').val(response.data.otp_verification).change();
                        $('#editRoleName').val(response.role).change();
                        $('#editBranchName').html(response.html);
                    },
                    beforeSend: function() {
