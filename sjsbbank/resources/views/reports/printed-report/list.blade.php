                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Sucessfully Printed Reports</h1>
                                 
                                    <!--begin::Card toolbar-->
                                    <div class="d-flex flex-wrap">
                                        @can('report.printed-report-pdf')
                                        ...
                                        @can('report.printed-report-excel')
                                        &nbsp;&nbsp;&nbsp;
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <!--begin::Add product-->
	...
	<script>
        ...
        function getPrintedReport(start_date="", end_date="", branch="", transaction=""){
        	$('#kt_ecommerce_products_table').DataTable({
                ...
                ajax: {
                    url: "{{ url('/report/printed-report-day-wise') }}",
                    method: "post",
        ...
        $('.exportAsExcel').click(function(){
            ...
            a.target= '_blank';
            a.href= "{{ url('/report/printed-report/excel?') }}"+frm 
            a.click();  
        })
        ...
        $('.exportAsPdf').click(function(){
            ...
            let a= document.createElement('a');
            a.target= '_blank';
            a.href= "{{ url('/report/printed-report/pdf?') }}"+frm 
            a.click();    
        })
