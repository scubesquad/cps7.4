                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Consolidated Report Monthly</h1>
                                 
                                    <!--begin::Card toolbar-->
                                    <div class="d-flex flex-wrap">
                                        @can('report.consolidate-report-monthly-pdf')
                                        ...
                                        @can('report.consolidate-report-monthly-excel')
                                        &nbsp;&nbsp;&nbsp;
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <!--begin::Add product-->
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <form method="get" class="mb-3" id="form">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12 @if(Request::is('report/printed-report-day-wise'))d-none @endif">
...
@push('scripts')
	...
	<script>
        ...
        getConsolidateMonthlyReport(startDate, endDate, "");
        function getConsolidateMonthlyReport(start_date="", end_date="", branch=""){
        	$('#kt_ecommerce_products_table').DataTable({
                ...
                ajax: {
                    url: "{{ url('/report/consolidated-report-monthly') }}",
                    method: "post",
        ...
        $('.exportAsExcel').click(function(){
            ...
            a.target= '_blank';
            a.href= "{{ url('/report/consolidated-report-monthly/excel?') }}"+frm 
            a.click();  
        })
        ...
        $('.exportAsPdf').click(function(){
            ...
            let a= document.createElement('a');
            a.target= '_blank';
            a.href= "{{ url('/report/consolidated-report-monthly/pdf?') }}"+frm 
            a.click();    
        })
