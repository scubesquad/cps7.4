                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    ...
                                    <li class="breadcrumb-item text-muted">
                                        <a href="javascript::void(0)" class="text-muted text-hover-primary">Reject Request Report</a>
                                    </li>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                        ...
                                        <form id="post_search_form" method="POST">
                                            <div class="row">
                                                <div class="col-lg-3 col-12">
                                                    ...
                                                    <input type="date" class="form-control" name="search_start_date" id="start_date" value="">
                                                </div>
                                                <div class="col-lg-3 col-12">
                                                    <label>Select End Date</label>
                                                    <input type="date" class="form-control" name="search_end_date" id="end_date" value="">
                                                </div>
                                                <div class="col-lg-3 col-12">
                                                    <div>&nbsp;</div>
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="show_status_upload_modal_form" class="form" action="#">
                    ...
                    <div class="mb-13 text-center">
                        <h1 class="mb-3">Reject Request Status</h1>
                    </div>
                    <!--end::Heading--> 
                    <!--begin::Input group-->
	...
	<script>
        ...
        $(document).ready(function(){
            ...
            table = $('#kt_ecommerce_products_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('getRejectRequestRecordAjax') }}",
                    type: "POST",
                    data: function (d) {
        ...
        function showStatus(id) {
            ...
            $.ajax({
                url: "/report/reject-request-report/"+id,
                type: "get",
