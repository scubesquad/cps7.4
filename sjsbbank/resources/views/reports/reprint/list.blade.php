                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Reprinted Reports</h1>
                                 
                                    <!--begin::Card toolbar-->
                                    <div class="d-flex flex-wrap">
                                        @can('report.reprint-pdf')
...
@push('scripts')
	...
	<script>
        ...
        $('.exportAsExcel').click(function(){
            ...
            a.target= '_blank';
            a.href= "{{ url('/report/reprint/excel?') }}"+frm 
            a.click();  
        })
        ...
        $('.exportAsPdf').click(function(){
            ...
            let a= document.createElement('a');
            a.target= '_blank';
            a.href= "{{ url('/report/reprint/pdf?') }}"+frm 
            a.click();    
        })
