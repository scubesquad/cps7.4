            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="add_state_modal_form" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label for="state_name" class="error"></label>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('body').on('click', '.btn-active-light-primary', function(){
                ...
                $.ajax({
                    url: "{{ url('/master/state/edit') }}"+ '/' +id,
                    type: "get",
                    success: function( response ) {
                        console.log(response)
                        $('#editId').val(response.data.state_id);
                        $('#editName').val(response.data.state_name);
                        $('#editCountryId').val(response.data.country_id).change();
                        $('#editStatus').val(response.data.is_delete).change();
                    },
                    beforeSend: function() {
