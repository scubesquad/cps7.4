                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <div class="row">
                                                            ...
                                                            <?php $role = ['role.view', 'role.edit', 'role.add','role.delete']; ?>
                                                            @php $i=1; @endphp
                                                            @foreach($permissions as $perm)
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                     <div class="row">
                                                          ...
                                                          <?php $cheque = ['account-charges.add', 'account-charges.edit', 'account-charges.view', 'account-charges.delete']; ?>
                                                          @php $i=1; @endphp
                                                          @foreach($permissions as $perm)
                                                          @if(in_array($perm->name, $cheque))
                                                          <div class="col-lg-3 col-md-6 col-12">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <div class="row">
                                                            ...
                                                            <?php $upload = ['transaction.view', 'transaction.upload', 'transaction.filter', 'transaction.delete', 'transaction.print', 'transaction.manual','transaction.list','transaction.reject']; ?>
                                                            @php $i=1; @endphp
                                                            @foreach($permissions as $perm)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <div class="row">
                                                            ...
                                                            <?php $upload = ['setting', 'positional-setting.view']; ?>
                                                            @php $i=1; @endphp
                                                            @foreach($permissions as $perm)
                                                            @if(in_array($perm->name, $upload))
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                     <div class="row">
                                                          ...
                                                          <?php $upload = ['print.send-to-branch-page','print.send-to-branch','print.ready-for-pickup-page','print.ready-for-pickup','print.pickup-page','print.pickup']; ?>
                                                          @php $i=1; @endphp
                                                          @foreach($permissions as $perm)
                                                          @if(in_array($perm->name, $upload))
                                                          <div class="col-lg-4 col-md-6 col-12">
