            ...
            $('.deleteSelected').click(function(){
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        console.log(val)
                        $.ajax({
                            url: "{{ url('/process/reprint/delete') }}",
                            type: "post",
                            data: {id:val},
            ...
            $('.printSelected').click(function(){
                ...
                if(val.length > 0)
                {
                    ...
                    swal.fire({
                        ...
                        if (result.isConfirmed) {
                            let url = "{{ url('/process/reprint/update?printinbunch=bunch') }}";
                            let reprintUrl = "";
                            if($("#requisitionCheckbox").prop('checked') == true){
                                reprintUrl =  "{{ url('/reprint-cheque?printinbunch=bunch&requisition=1') }}";
                            }else{
                                reprintUrl = "{{ url('/reprint-cheque?printinbunch=bunch') }}";
                            }
                ...
                if(val.length > 0)
                {
                    ...
                    if(page_nos != null && page_nos != "")
                    {
                        swal.fire({
                            ...
                            if (result.isConfirmed) {
                                let executeUrl = "{{ url('/process/reprint/update') }}";
                                let redirecturl = "";
                                if($("#requisitionCheckbox").prop('checked') == true){
                                    redirecturl = "{{ url('/reprint-cheque?selective_pages_no="+selective_pages_no+"&requisition=1') }}";
                                }else{
                                    redirecturl = "{{ url('/reprint-cheque?selective_pages_no=') }}"+selective_pages_no;
                                }
            ...
            $('.printRequisitionSlipOnly').click(function(){
                ...
                if(val.length > 0)
                {
                    ...
                    swal.fire({
                        ...
                        if (result.isConfirmed) {
                            let url = "{{ url('/process/reprint/update') }}";
                            let executeUrl = "{{ url('/reprint-cheque?requisitiononly=1') }}";
