...
use App\Http\Controllers\AccountChargesController;
use App\Http\Controllers\RejectTransactionController;
...
// Route::domain('{subdomain}.'.config('app.short_url'))->group(function(){
    Route::group(['middleware' => ['auth']], function() {
        ...
        Route::post('dashboardAjaxSearch', [AjaxController::class, 'dashboardAjaxSearch'])->name('dashboard.ajax_search');
        ...
        Route::post('master/role/delete', [RoleController::class, 'delete']);
        ...
        // Route For account charges
        Route::get('master/account-charges/list', [AccountChargesController::class, 'list']);
        Route::post('master/account-charges/list', [AccountChargesController::class, 'getList']);
        Route::get('master/account-charges/edit/{id}', [AccountChargesController::class, 'edit']);
        Route::post('master/account-charges/store', [AccountChargesController::class, 'store']);
        Route::post('master/account-charges/update', [AccountChargesController::class, 'update']);
        Route::post('master/account-charges/delete', [AccountChargesController::class, 'delete']);
        ...
        Route::post('getUploadRecordAjax', [UploadTransactionController::class, 'getUploadRecordAjax'])->name('getUploadRecordAjax');
        ...
        Route::post('ajaxGetAccountDetails', [AjaxController::class, 'ajaxGetAccountDetails'])->name('ajaxGetAccountDetails');
        // additional route
        ...
        Route::post('getPrintRecordAjax', [TransactionListController::class, 'getPrintRecordAjax'])->name('getPrintRecordAjax');

        Route::post('getPrintSendToBranchRecordAjax', [TransactionListController::class, 'getPrintSendToBranchRecordAjax'])->name('getPrintSendToBranchRecordAjax');
        Route::post('getPrintReadyForPickupRecordAjax', [TransactionListController::class, 'getPrintReadyForPickupRecordAjax'])->name('getPrintReadyForPickupRecordAjax');

        

        Route::post('transaction/list/send-to-branch', [TransactionListController::class, 'sendToBranchAjax']);
        Route::post('transaction/list/ready-for-pickup', [TransactionListController::class, 'readyForPickupAjax']);
        Route::post('transaction/list/pickup-up', [TransactionListController::class, 'pickupUpAjax']);
        // end print request list


        // reject request details report
        Route::get('report/reject-request-report', [RejectTransactionController::class, 'index'])->name('reject-request.report');
        Route::post('getRejectRequestRecordAjax', [RejectTransactionController::class, 'getRejectRequestRecordAjax'])->name('getRejectRequestRecordAjax');
        Route::get('report/reject-request-report/{id}', [RejectTransactionController::class, 'showStatusReport']);

        // details report
        Route::get('report/printed-detail-report', [TransactionReportController::class, 'index'])->name('transaction.report');
        Route::post('getPrintReportRecordAjax', [TransactionReportController::class, 'getPrintReportRecordAjax'])->name('getPrintReportRecordAjax');
        Route::get('report/printed-detail-report/{id}', [TransactionReportController::class, 'showStatusReport']);

        Route::get('report/printed-detail-report/generatePdf', [TransactionReportController::class, 'generatePdf'])->name('detailReportGeneratePdf');
        ...
        Route::post('getPendingPrintRequestRecordAjax', [PendingPrintRequestController::class, 'getPendingPrintRequestRecordAjax'])->name('getPendingPrintRequestRecordAjax');
        Route::get('pending-print-req/list/{id}', [PendingPrintRequestController::class, 'edit']);
        Route::post('pending-print-req/update/{id?}', [PendingPrintRequestController::class, 'editAjaxUpdate'])->name('pending_print_req.ajax_update');

        Route::post('pending-print-req/list/reject-print-request', [PendingPrintRequestController::class, 'rejectPrintReuest']);
