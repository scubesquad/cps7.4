...
(0001, 'WARDHA ZILLA PARISHAD EMPLOYEES URBAN CO-OPERATIVE BANK LTD, WARDHA', 804, 'MAHADEOPURA', '', '', 1, 2, 1, 1, '442001', '', '', '', '', 0, 0, '', '', '', 'a:1:{i:0;a:3:{i:0;s:40:\"0000HP6B4A7C (HP LaserJet Pro M404-M405)\";i:1;s:6:\"Tray 1\";i:2;s:6:\"Tray 2\";}}');
...
(1, '001', 'BRANCH', '', '', 'MAHADEOPURA', '', '', 1, 2, 1, 1, 442001, '', '', '', '', '', '', '', '', NULL, 'ICIC00WZPEC', NULL, NULL, 0, 0, '', 0, 442, '', '', '', '', '', '442');
...
('', 'uploads/', 'Excel', '', '', 'Excel', '', '', 0, 0, 000000, 000000, 9, 365, 'WARDHA ZILLA PARISHAD EMPLOYEES URBAN CO-OPERATIVE BANK LTD, WARDHA', 'DevHarsh Infotech Pvt Ltd', 'thane logo.jpg', 'Penguins.jpg', '', '', '', '', '', 360, '', '', '', '0000-00-00', 0, '0000-00-00', 0, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `tb_positions` (
  ...
  `BankAddrY` int DEFAULT NULL,
  `AcnoY` int DEFAULT NULL,
  `AcnoPrefixY` int DEFAULT NULL,
  `IfscY` int DEFAULT NULL,
  `NameY` int DEFAULT NULL,
  `VUniqReqY` int DEFAULT NULL,
  `MICRY` int DEFAULT NULL,
  `bearerY` int DEFAULT NULL,
  `branchX` int DEFAULT NULL,
  `ifscX` int DEFAULT NULL,
  `accnoX` int DEFAULT NULL,
  `acnoPrefixX` int DEFAULT NULL,
  `bearerX` int DEFAULT NULL,
  `chqseriesX` int DEFAULT NULL,
  `micr1X` int DEFAULT NULL,
  `micr2X` int DEFAULT NULL,
  `trncodeX` int DEFAULT NULL,
...
(19, 00000000, 442804001, 001, '35823566823', 'TEST', 01, '0', 003, 10, '', '', '', '', '', '', 'TEST', '', '', '', '', 'test', '', '', '', 415263, '', '', '', 'HDFC0CVCBL1', 000004, 000006, 413240, '2023-12-25', 1, '', '', 'TESA', NULL, NULL, NULL);
...
(1, 00000000, 442804001, 001, '35823566823', 'ROHIT BACHKAR', 01, '0', 003, 10, '', '', '', '', '', '', 'MUMBAI', '', '', '', '', 'Mumbai', '', '', '', 442001, '', '', '', '', 000001, 000003, 415263, '2023-12-25', 1, 0, '', '', NULL, NULL, NULL, NULL);
