              ...
              <tr>
                  ...
                  <div style="float:left;clear: borh;height: 40px;"><label>Select Branch </label>
							<select name="ddlBranchName" id="ddlBranchName" style="width:198px; height:26px;">
								...
								<?php 
									$rowgetbranch =  $db->get_results("SELECT distinct(b.branch_micr),b.branch_id, b.branch_name FROM tb_branchdetails b INNER JOIN tb_print_req_collection prc ON b.branch_micr = prc.cps_micr_code AND b.branch_sub_code= prc.branch_sub_code");
									if($rowgetbranch){
