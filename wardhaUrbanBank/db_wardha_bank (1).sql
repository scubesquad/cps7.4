...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 04, 2024 at 08:12 AM
...
(0001, 'WARDHA ZILLA PARISHAD EMPLOYEES URBAN CO-OP BANK LTD, WARDHA', 804, 'MAHADEOPURA', '', '', 1, 2, 1, 1, '442001', '', '', '', '', 0, 0, '', '', '', 'a:1:{i:0;a:3:{i:0;s:29:\"NPIA705BA (HP LaserJet M403n)\";i:1;s:6:\"Tray 1\";i:2;s:6:\"Tray 2\";}}');
...
(1, '001', 'WARDHA', '442804001', '', 'MAHADEOPURA', '', '', 1, 2, 1, 1, 442001, '', '', '', '', '', '', '', '', NULL, 'ICIC00WZPEC', NULL, NULL, 0, 0, '', 0, 442, '', '', '', '', '', '003'),
(2, '502', 'DEOLI', '442804502', '', 'MAIR ROAD NEAR BOI IN FRONT OF TADAS COMPLEX DEOLI', '', '', 1, 2, 1, 1, 442001, '', '', '', '', '7158254004', '', '', '', NULL, 'ICIC00WZPEC', NULL, NULL, 0, 0, '', 0, 442, '', '', '', '', '', '004'),
(3, '302', 'ARVI', '442804302', '', 'JAJU WADI NEAR ASHIRWAD MANGAL KARYALAYA ARVI', '', '', 1, 2, 1, 1, 442001, '', '', '', '', '', '', '', '', NULL, 'ICIC00WZPEC', NULL, NULL, 0, 0, '', 0, 442, '', '', '', '', '', '005'),
(4, '501', 'SELOO', '442804501', '', 'NAGPUR ROAD SELOO', '', '', 1, 2, 1, 1, 442001, '', '', '', '', '7155221207', '', '', '', NULL, 'ICIC00WZPEC', NULL, NULL, 0, 0, '', 0, 442, '', '', '', '', '', '006'),
(5, '504', 'KARANJA ', '442804504', '', 'NEAR MODEL HIGH SCHOOL KARANJA', '', '', 1, 2, 1, 1, 442001, '', '', '', '', '7156245846', '', '', '', NULL, 'ICIC00WZPEC', NULL, NULL, 0, 0, '', 0, 442, '', '', '', '', '', '007'),
(6, '505', 'HINGANGHAT', '442804505', '', 'NETAJI NAHAR NEAR SBI HINGANGHAT', '', '', 1, 2, 1, 1, 442001, '', '', '', '', '7153244250', '', '', '', NULL, 'ICIC00WZPEC', NULL, NULL, 0, 0, '', 0, 442, '', '', '', '', '', '008'),
(7, '503', 'SAMUDRAPUR', '442804503', '', 'DIMAND GALEXY COMPLEX GIRAD ROAD SAMUDRAPUR', '', '', 1, 2, 1, 1, 442001, '', '', '', '', '7151225445', '', '', '', NULL, 'ICIC00WZPEC', NULL, NULL, 0, 0, '', 0, 442, '', '', '', '', '', '009');
...
(001, 'WAR001', 'WARDHA', 'SOL', 1, 2, 0),
(002, 'DEO001', 'DEOLI', 'DEO', 1, 2, 0),
(003, 'ARV001', 'ARVI', 'ARV', 1, 2, 0),
(004, 'SEL001', 'SELOO', 'SEL', 1, 2, 0),
(005, 'KAR001', 'KARANJA ', 'KAR', 1, 2, 0),
(006, 'HIN001', 'HINGANGHAT', 'HIN', 1, 2, 0),
(007, 'SAM001', 'SAMUDRAPUR', 'SAM', 1, 2, 0);
...
(3, 10, 1, 1, 000000, 999999, 000301, 1, '003'),
(4, 11, 1, 1, 000000, 999999, 000091, 1, '001'),
(5, 13, 1, 1, 000001, 999999, 000001, 1, '001'),
(6, 14, 1, 1, 000000, 999999, 000001, 1, '001');
...
CREATE TABLE IF NOT EXISTS `tb_cps_settings` (
  ...
  `cps_unique_req` int(11) NOT NULL
...
CREATE TABLE IF NOT EXISTS `tb_pending_print_req` (
  ...
  `cps_auth_sign1` varchar(35) NOT NULL,
  `cps_auth_sign2` varchar(35) NOT NULL,
  `cps_auth_sign3` varchar(50) NOT NULL,
  `cps_act_address1` varchar(50) NOT NULL,
  `cps_act_address2` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_positions` (
  ...
  `BankAddrY` int(11) DEFAULT NULL,
  `AcnoY` int(11) DEFAULT NULL,
  `AcnoPrefixY` int(11) DEFAULT NULL,
  `IfscY` int(11) DEFAULT NULL,
  `NameY` int(11) DEFAULT NULL,
  `VUniqReqY` int(11) DEFAULT NULL,
  `MICRY` int(11) DEFAULT NULL,
  `bearerY` int(11) DEFAULT NULL,
  `branchX` int(11) DEFAULT NULL,
  `ifscX` int(11) DEFAULT NULL,
  `accnoX` int(11) DEFAULT NULL,
  `acnoPrefixX` int(11) DEFAULT NULL,
  `bearerX` int(11) DEFAULT NULL,
  `chqseriesX` int(11) DEFAULT NULL,
  `micr1X` int(11) DEFAULT NULL,
  `micr2X` int(11) DEFAULT NULL,
  `trncodeX` int(11) DEFAULT NULL,
...
INSERT INTO `tb_positions` (`id`, `type`, `BankAddrY`, `AcnoY`, `AcnoPrefixY`, `IfscY`, `NameY`, `VUniqReqY`, `MICRY`, `bearerY`, `branchX`, `ifscX`, `accnoX`, `acnoPrefixX`, `bearerX`, `chqseriesX`, `micr1X`, `micr2X`, `trncodeX`, `is_delete`) VALUES
(1, 'Cheque 1', 10, 47, 28, 15, 47, 70, 83, 21, 30, 30, 34, 166, 193, 60, 88, 122, 148, 0),
(2, 'Cheque 2', 103, 140, 120, 108, 139, 160, 176, 114, 30, 30, 34, 166, 193, 60, 88, 122, 148, 0),
(3, 'Cheque 3', 197, 233, 214, 202, 233, 260, 267, 207, 30, 30, 34, 166, 193, 60, 88, 122, 148, 0),
(4, 'slip 1', 0, 0, 0, 0, 0, 0, 0, 0, 10, 15, 0, 0, 0, 0, 0, 0, 0, 0),
(5, 'slip 2', 0, 0, 0, 0, 0, 0, 0, 0, 10, 15, 0, 0, 0, 0, 0, 0, 0, 0),
(6, 'slip 3', 0, 0, 0, 0, 0, 0, 0, 0, 10, 15, 0, 0, 0, 0, 0, 0, 0, 0);
...
(46, 00000018, 442804001, 001, '2388788557', 'ABCEDER', 01, '0', 010, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'HDFC0CVUCBL', '000071', 000080, 454857, '2024-02-20', 1, 0, '', '', NULL, NULL, NULL, NULL),
(47, 00000019, 442804001, 001, '2388788557', 'ABCEDER', 05, '0', 030, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', '431122', '', '', '', 454645, '324', '23', '', 'SVCB0054004', '000221', 000370, 454857, '2024-02-21', 1, 0, '', '', 'AB', '', '', NULL),
(48, 00000020, 442804001, 001, '2388788557', 'ABCEDER', 01, '0', 030, 10, '', 'ASD', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'HDFC0CVUCBL', '000251', 000280, 454857, '2024-02-21', 1, 0, '', '', 'AB', '', '', NULL),
(49, 00000021, 442804001, 001, '2388788557', 'ABCEDER', 05, '1', 030, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000251', 000400, 434343, '2024-02-21', 1, 0, '', '', '', '', '001', NULL),
(50, 00000021, 442804001, 001, '2388788557', 'ABCEDER', 05, '1', 030, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000251', 000400, 434343, '2024-02-21', 1, 0, '', '', '', '', '001', NULL),
(51, 00000021, 442804001, 001, '2388788557', 'ABCEDER', 05, '1', 030, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000251', 000400, 434343, '2024-02-21', 1, 0, '', '', '', '', '001', NULL),
(52, 00000022, 442804001, 001, '01100620002', 'ABCEDER', 03, '0', 030, 11, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000001', 000090, 000133, '2024-02-21', 1, 0, '', '', 'AB', '', '001', NULL),
(53, 00000023, 442804001, 001, '2388788557', 'ABCEDER', 02, '1', 010, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000401', 000420, 434343, '2024-02-21', 1, 0, '', '', 'AB', '', '001', NULL),
(54, 00000024, 442804001, 001, '2388788557', 'ABCEDER', 05, '0', 030, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000001', 000150, 000133, '2024-02-27', 1, 0, '', '', '', '', '003', NULL),
(55, 00000024, 442804001, 001, '2388788557', 'ABCEDER', 05, '0', 030, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000001', 000150, 000133, '2024-02-27', 1, 0, '', '', '', '', '003', NULL),
(56, 00000024, 442804001, 001, '2388788557', 'ABCEDER', 05, '0', 030, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000001', 000150, 000133, '2024-02-27', 1, 0, '', '', '', '', '003', NULL),
(57, 00000024, 442804001, 001, '2388788557', 'ABCEDER', 05, '0', 030, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000001', 000150, 000133, '2024-02-27', 1, 0, '', '', '', '', '003', NULL),
(58, 00000025, 442804001, 001, '2388788557', 'ABCEDER', 05, '0', 030, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000151', 000300, 000133, '2024-02-27', 1, 0, '', '', '', '', '003', NULL),
(59, 00000026, 442804001, 001, '2388788557', 'ABCEDER', 01, '0', 030, 11, '', '', '', '', '', '', 'AASDSD', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000091', 000120, 454857, '2024-02-29', 1, 0, '', '', '', '', '003', NULL),
(60, 00000026, 442804001, 001, '2388788557', 'ABCEDER', 01, '0', 030, 11, '', '', '', '', '', '', 'AASDSD', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', '000091', 000120, 454857, '2024-02-29', 1, 0, '', '', '', '', '003', NULL);
...
CREATE TABLE IF NOT EXISTS `tb_print_sequence` (
  ...
  `cps_act_jointname1` varchar(45) NOT NULL,
  `cps_act_jointname2` varchar(45) NOT NULL,
  `cps_auth_sign1` varchar(50) NOT NULL,
  `cps_auth_sign2` varchar(35) NOT NULL,
  `cps_auth_sign3` varchar(35) NOT NULL,
  `cps_act_address1` varchar(50) NOT NULL,
  `cps_act_address2` varchar(50) NOT NULL,
...
(1, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 01, '1', 030, 10, '', 'ASD', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 000044, 000060, 454857, '2024-02-13', 1, 0, '', '', NULL, NULL, NULL, NULL),
(2, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 01, '1', 030, 10, '', 'ASD', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 000044, 000060, 454857, '2024-02-13', 1, 0, '', '', NULL, NULL, NULL, NULL),
(3, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 01, '1', 030, 10, '', 'ASD', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 000044, 000060, 454857, '2024-02-13', 1, 0, '', '', NULL, NULL, NULL, NULL),
(4, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 01, '1', 030, 10, '', 'ASD', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 000044, 000060, 454857, '2024-02-13', 16, 0, '', '', NULL, '', NULL, NULL),
(5, 00000000, 442804001, 001, '2388788557', 'TEST5', 01, '0', 005, 10, '', '', '', '', '', '', 'FDGFDG', '', '', '', '', 'mum', '', '', '', 454645, '', '', '', 'SVCB0054004', 004444, 004449, 454857, '2024-02-16', 1, 0, '', '', NULL, NULL, NULL, NULL),
(6, 00000000, 442804001, 001, '2388788557', 'TEST5', 01, '0', 005, 10, '', '', '', '', '', '', 'FDGFDG', '', '', '', '', 'mum', '', '', '', 454645, '', '', '', 'SVCB0054004', 004444, 004449, 454857, '2024-02-16', 16, 0, '', '', NULL, '', NULL, NULL),
(7, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 01, '0', 005, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'mum', '', '', '', 534543, '', '', '', 'HDFC0CVUCBL', 004444, 004449, 000133, '2024-02-16', 1, 0, '', '', NULL, NULL, NULL, NULL),
(8, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 01, '0', 005, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'mum', '', '', '', 534543, '', '', '', 'HDFC0CVUCBL', 004444, 004449, 000133, '2024-02-16', 1, 0, '', '', NULL, NULL, NULL, NULL),
(9, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 03, '0', 005, 11, '', '', '', '', '', '', 'SDSDSDSS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 004444, 004449, 454857, '2024-02-16', 16, 0, '', '', NULL, '', NULL, NULL),
(10, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 03, '0', 005, 11, '', '', '', '', '', '', 'SDSDSDSS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 004444, 004449, 454857, '2024-02-16', 16, 0, '', '', NULL, '', NULL, NULL),
(11, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 03, '0', 005, 11, '', '', '', '', '', '', 'SDSDSDSS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 004444, 004449, 454857, '2024-02-16', 16, 0, '', '', NULL, '', NULL, NULL),
(12, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 03, '0', 005, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 004444, 004449, 454857, '2024-02-16', 16, 0, '', '', NULL, '', NULL, NULL),
(13, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 03, '0', 005, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 004444, 004449, 454857, '2024-02-16', 16, 0, '', '', NULL, '', NULL, NULL),
(14, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 03, '0', 005, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 004444, 004449, 454857, '2024-02-16', 16, 0, '', '', NULL, '', NULL, NULL),
(15, 00000000, 442804001, 001, '2388788557', 'ABCEDER', 03, '0', 005, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'SVCB0054004', 004444, 004449, 454857, '2024-02-16', 1, 0, '', '', NULL, NULL, NULL, NULL),
(16, 00000018, 442804001, 001, '2388788557', 'ABCEDER', 01, '0', 010, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'HDFC0CVUCBL', 000071, 000080, 454857, '2024-02-20', 1, 0, '', '', NULL, NULL, NULL, NULL),
(17, 00000022, 442804001, 001, '01100620002', 'ABCEDER', 03, '0', 030, 11, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', 000001, 000090, 000133, '2024-02-21', 16, 0, '', '', NULL, '', '001', NULL),
(18, 00000023, 442804001, 001, '2388788557', 'ABCEDER', 02, '1', 010, 10, '', '', '', '', '', '', 'SDSDSDS', '', '', '', '', 'fdrge', '', '', '', 454645, '', '', '', 'ICIC00WZPEC', 000401, 000420, 434343, '2024-02-21', 16, 0, '', '', NULL, '', '001', NULL);
...
(1, 'WARDHA', '442001', 'WAR001', 'SOL', 1, 2, 1, 0),
(2, 'DEOLI', '414001', 'DEO001', 'DEO', 1, 2, 2, 0);
