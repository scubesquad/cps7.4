...
require_once(ROOT_CLASSES.'tcpdf/tcpdf.php');
	...
	if(isset($_GET['accountno']) && !empty($_GET['accountno'])){
		$condation .= " AND cps_account_no LIKE '%".$_GET['accountno']."%'";
	}
...
if($result = $db->get_results($sql)){
	$data .='<div style="border-bottom-color: #4487A9;border-bottom-style: solid;height: 87px;margin-bottom: 0;margin-left: 0;margin-right: 0;margin-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;padding-top: 0;width: 100%;"><div id="titlediv" style="font-size: 25px;text-align:left;"><b>Sucessfully Printed Reports.</b><div style="font-size: 40px; float: left;">';
	if($branch != "")
	{
