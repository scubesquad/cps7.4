...
?>
			...
			<?php elseif($_SESSION['user_type']==1) :?>
				...
				<!-- <li><a href="loose_reprint.php">Loose reprint</a></li> -->
        	...
        	<div class="middlesubdiv">
        	  ...
        	  <!--1st drop down menu -->   
                <div id="dropmenu1_e" class="dropmenudiv_e">
					...
					<!-- <a href="manage_looseseries.php" <?php echo authentication_groups_pemissions("payorderseries_master","menu","Y");?>>Loose Series Master</a> -->
                ...
                <div id="dropmenu2_e" class="dropmenudiv_e">
					...
					<!-- <a href="loose_request.php" <?php //echo authentication_groups_pemissions("reprint_request","menu","Y");?> >Loose Reprint Request</a> -->
					<a href="payorder_print.php" <?php //echo authentication_groups_pemissions("payorder_print","menu","Y");?> >Pay order Print</a>
					<!-- <a href="loose_print.php" <?php //echo authentication_groups_pemissions("payorder_print","menu","Y");?> >Loose Cheque Print</a> -->
				</div>
