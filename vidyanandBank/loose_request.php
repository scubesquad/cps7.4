	...
	$( "#dialog-confirm" ).dialog({
            ...
            buttons: {
                ...
                Ok: function() {  
						...
						$.ajax({type: "POST", url: "post_loose_request.php", dataType: 'json', data: "do=reprint&ids="+selected_ids_array,
							success: function(resObj, statusText) {
								if(resObj.status) {                            
									$('#successful').html('<div class="errormsg_boundary">You request is placed to admin.<div>').show();
									$( this ).dialog( "close" );								
								} else {
									$('#successful').html('<div class="errormsg_boundary">Duplicate record in loose reprint request.<div>').show();
									$( this ).dialog( "close" );
									return false;
								}
							}
...
<div id="formdiv">
	<div id="formheading">Loose Reprint Cheques</div>
	<div id="formfields">
		<form id="frmreprint" name="frmreprint" enctype="multipart/form-data" action="post_loose_request.php" method="POST">
