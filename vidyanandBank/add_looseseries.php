...
<script type="text/javascript" src="scripts/dropdowntabs.js"></script>
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#submit1').button();		
			$('#frmlooseseries').validate({
				rules: vRules,
				messages: vMessages,
				submitHandler: function(form) {
					$('#frmlooseseries').ajaxSubmit({
						target: '#response', 
...
<?php require_once('header.php');?>
                <div id="formdiv">
                    ...
                    <div id="formfields">
                   <form id="frmlooseseries" name="frmlooseseries" enctype="multipart/form-data" action="post_looseseries.php" method="POST" autocomplete="off">
