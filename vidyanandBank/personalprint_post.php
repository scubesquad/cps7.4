	...
	if(isset($_POST['ddlAccountType']) && $_POST['ddlAccountType'] != "" ){
		...
		//if($rowchkserise){
			...
			{	
				...
				$rowchkserise = $db->get_row("SELECT series_lastno FROM tb_cps_chequeseries WHERE series_transationcode = '".$_POST['ddlAccountType']."' AND serise_branchcode_branch = '".$_POST['branchCode']."' and AND serise_branchcode_branch = '".$_POST['branchCode']."' ");				
