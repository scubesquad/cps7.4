    ...
    /*  print_r($result);
      exit;*/
               ...
               // echo "SELECT branch_name from tb_branchdetails where ABS(branch_code)='".(int)$result[0]->cps_branchmicr_code."'";
                ...
                $data .= '<tr><td class="thwidthtd" colspan="12" style="font-size:20px;"><b>'.$branch_name.' - '.$result[0]->cps_branchmicr_code.'</b></td></tr>' ;
            ...
            switch ($prevTrCode) {
             ...
             /*if($prevTrCode==10){
              ...
              $data = '<table cellpadding="2" cellspacing="0" border="1" width="100%">';
                ...
                $data .= '<tr><td class="thwidthtd" colspan="12" style="font-size:20px;">No data found!</td></tr>' ;
                $data .= '</table>';
    }
...
print_r($sql);
           ...
           //   print_r($result);
             // exit;
                        ...
                        $data .= '<tr><td class="thwidthtd" colspan="11" style="font-size:20px;"><b>'.$branch_name.' - '.$result[0]->cps_branchmicr_code.'</b></td></tr>' ;
             ...
             switch ($prevTrCode) {
              ...
              $data .= '<tr><td style="font-size:20px;"></td></tr>' ;
              $data .= '</table>';
