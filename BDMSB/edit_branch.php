				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						<td height="35" align="left" valign="top" width="20%"><label>Branch MICR Code</label><span class="red">*</span>
						</td>
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" value="<?php echo stripslashes($row->branch_micr); ?>" name="branchmirc" id="branchmirc" maxlength="11" style="width:190px;" />
							</label>
						</td>
					  </tr>
