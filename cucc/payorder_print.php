...
function printCheques($type,$firstchequedata,$secondchequedata,$thirdchequedata,$noofCheque,$printersinfo)
{
	...
	// Positions
	$arrPos    = array(); 
	$arrPos[0] = array("BankAddrY" => 12.5, "ifscY" => 56.5, "PayOrderY" => 28.3, "VUniqReq" => 76, "MICRY" => 86.7);
	$arrPos[1] = array("BankAddrY" => 106, "ifscY" => 150, "PayOrderY" => 121, "VUniqReq" => 169, "MICRY" => 180.5);
	$arrPos[2] = array("BankAddrY" => 199, "ifscY" => 243, "PayOrderY" => 214, "VUniqReq" => 262, "MICRY" => 273.5);
