	...
	if(@$_FILES['uploadedfile']['name']!='')
	{
		...
		if(!$entries_found)
		{
			...
			foreach ($data as $key => $explode) {
				...
				$explode[9] = str_replace("'", "\'", $explode[9]);
				$explode[10] = str_replace("'", "\'", $explode[10]);
				...
				cps_act_mobile, cps_act_telephone_res, cps_act_telephone_off,cps_bsr_code,cps_short_name
				...
				'$explode[23]', '$explode[21]', '$explode[22]','$explode[33]','$explode[26]'
				)";
